...
/**
  ...
  */
	public AdminStatisticsPanel(Personlist l,List<Validations> v, Cardlist cr )
	{
		setBackground(new Color(200, 230, 255));


		// setting "firstLight" to the day when our Skiresort first saw the day of light, currently 010113.
...
/**
  * A method to retrieve the start Date of the range. If no start Date is specified, it will use the date when this Skiresort first opened.
